...
class CloudSearchSearchTest(unittest.TestCase):
    ...
    def setUp(self):
        HTTPretty.enable()
        HTTPretty.register_uri(HTTPretty.GET, "http://search-demo-userdomain.us-east-1.cloudsearch.amazonaws.com/2011-02-01/search",
    ...
    def test_cloudsearch_qsearch(self):
        search = SearchConnection(endpoint="search-demo-userdomain.us-east-1.cloudsearch.amazonaws.com")
    ...
    def test_cloudsearch_facet_constraint_single(self):
        ...
        self.assertEqual(args['facet-author-constraints'], ["'John Smith','Mark Smith'"])
    ...
    def test_cloudsearch_facet_constraint_multiple(self):
        ...
        self.assertEqual(args['facet-author-constraints'], ["'John Smith','Mark Smith'"])
        self.assertEqual(args['facet-category-constraints'], ["'News','Reviews'"])
    ...
    def test_cloudsearch_results_info(self):
        ...
        # This rely on the default response which is fed into HTTPretty
